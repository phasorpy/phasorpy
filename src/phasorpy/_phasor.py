"""Calculate and transform phasor coordinates."""
...
def phasor_to_principal_plane(
    ...
    *,
    ...
    .. [5] Franssen WMJ, Vergeldt FJ, Bader AN, van Amerongen H, and Terenzi C.
...
def phasor_center(
    ...
    **kwargs
    ...
    if nan_safe:
        from ._filter import phasor_threshold
