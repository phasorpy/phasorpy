"""Fluorescence lifetime calculations, including FRET."""
...
def lifetime_to_signal(
    ...
    *,
    ...
    See Also
    --------
    phasorpy.phasor_from_lifetime
    phasorpy.phasor_to_signal
...
def phasor_calibrate(
    ...
    *,
    ...
    See Also
    --------
    phasorpy.phasor_transform
    phasorpy.polar_from_reference_phasor
    phasorpy.phasor_center
    phasorpy.phasor_from_lifetime
...
def phasor_to_apparent_lifetime(
    ...
    **kwargs
    ...
    See Also
    --------
    phasorpy.phasor_from_apparent_lifetime
...
def phasor_from_apparent_lifetime(
    ...
    **kwargs
    ...
    See Also
    --------
    phasorpy.phasor_to_apparent_lifetime
...
def lifetime_fraction_to_amplitude(
    ...
    See Also
    --------
    phasorpy.lifetime_fraction_from_amplitude
...
def lifetime_fraction_from_amplitude(
    ...
    See Also
    --------
    phasorpy.lifetime_fraction_to_amplitude
...
def polar_to_apparent_lifetime(
    ...
    **kwargs
    ...
    See Also
    --------
    phasorpy.polar_from_apparent_lifetime
...
def polar_from_apparent_lifetime(
    ...
    **kwargs
    ...
    See Also
    --------
    phasorpy.polar_to_apparent_lifetime
...
def phasor_from_fret_donor(
    ...
    **kwargs
    ...
    See Also
    --------
    phasorpy.phasor_from_fret_acceptor
...
def phasor_from_fret_acceptor(
    ...
    **kwargs
    ...
    See Also
    --------
    phasorpy.phasor_from_fret_donor
    :ref:`sphx_glr_tutorials_api_phasorpy_fret.py`
