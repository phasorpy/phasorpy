...
def anscombe_transform(
    ...
    **kwargs
    ...
    Notes
    -----
    The Anscombe transformation according to [6]_:
...
def anscombe_transform_inverse(
    ...
    **kwargs
    ...
    The approximate inverse Anscombe transformation according to [7]_ and [8]_:
