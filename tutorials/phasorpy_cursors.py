...
signal = tifffile.imread("SP_paramecium.lsm")
mean, real, imag = phasor_from_signal(signal, axis=0)

label = circular_cursor(real, imag, numpy.array([[-0.48, -0.65], [-0.22, -0.75], 
                             [0.40, -0.80], [0.66, -0.68]]), 
...
rang = numpy.array([(0, numpy.pi), (-numpy.pi/2, 0), 
                    (-numpy.pi, -numpy.pi/2)])
label = range_cursor(phase, ranges=rang)
