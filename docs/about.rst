...
Technical direction is developed through open discussion and
consensus-building in issues, pull requests, and community meetings.
...
We thank the PhasorPy user community for feedback, bug reports, feature
suggestions, and data files that have helped improve the library.

We acknowledge the open-source scientific Python ecosystem that PhasorPy
builds on, including Python, NumPy, SciPy, Matplotlib, and scikit-learn,
the microscopy file-format stack (including tifffile, ptufile, and related
tools), and the documentation toolchain based on Sphinx and Sphinx-Gallery.
