...
functions have been renamed to ``phasor_component_fraction`` and
...
Three new tutorials have been added: "Geometrical interpretation of lifetimes",
"Multi-component fit", and "FRET efficiency image".

This release supports Python 3.11 through 3.13.
