...
def test_wavelength2rgb():
    ...
    assert_array_equal(
        wavelength2rgb([517, 566], numpy.uint8),
        numpy.array([[0, 191, 0], [133, 190, 0]], numpy.uint8),
    )

    assert_array_equal(
        wavelength2rgb([517, 566], numpy.float16),
        numpy.array([[0, 0.749744, 0], [0.52133, 0.744288, 0]], numpy.float16),
    )
